...
export type ToastConfigRendererPropsType<T = unknown> = { props: ToastRenderProps; data: T }

export interface IToastConfig<RendererPropsType extends ToastConfigRendererPropsType = ToastConfigRendererPropsType> {
...
export interface IToastPromiseRenderers<PromiseResolvedType> {
    ...
    success: IToastConfig<ToastConfigRendererPropsType<PromiseResolvedType>>['render']
