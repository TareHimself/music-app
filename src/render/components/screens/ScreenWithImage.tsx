  ...
  return (
    <div className="screen">
      ...
      <div className="screen-fg">
        ...
        <img src={props.cover} onLoad={onImageLoaded} alt="Cover" className="cover" style={{ position: 'absolute', filter: 'blur(40px)'}}/>
          <img src={props.cover} onLoad={onImageLoaded} alt="Cover" onContextMenu={props.onImageContextMenu} onError={props.onImageLoadError} className="cover" style={{zIndex: 1 }}/>
